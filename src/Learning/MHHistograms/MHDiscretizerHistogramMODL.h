...
class MHDiscretizerHistogramMODL : public KWDiscretizerMODL
{
public:
	// Constructeur
	MHDiscretizerHistogramMODL();
	~MHDiscretizerHistogramMODL();
	...
	void DiscretizeValues(ContinuousVector* cvSourceValues, IntVector* ivTargetIndexes, int nTargetValueNumber,
			      KWFrequencyTable*& kwftTarget) const override;
...
protected:
	...
	// Methode de post-traitement d'un histogramme construit pour diminuer le nombre d'intervalles
	// selon la contrainte utilisateur
	void MainSimplifyHistogram(const ContinuousVector* cvSourceValues, const MHHistogram* optimizedHistogram,
	...
	//    (methode ComputeHistogramLowerBound et ComputeHistogramUUpperBound de MHHistogramSpec)
