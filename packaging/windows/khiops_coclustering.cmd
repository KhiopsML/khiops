...
if not exist "%KHIOPS_COCLUSTERING_PATH%" goto ERR_PATH_2
...
:ERR_PATH_2
start "KHIOPS CONFIGURATION PROBLEM" echo ERROR "Incorrect installation directory for Khiops (File %KHIOPS_COCLUSTERING_PATH% not found)"
exit /b 1
