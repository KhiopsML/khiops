...
public:
	...
	// optimise en ignorant les attributs en sortie non utilises, et les attributs en entree a l'orinine
	// de ces attributs en sortie non utilises. Par contre, ces attributs sont necessaires
