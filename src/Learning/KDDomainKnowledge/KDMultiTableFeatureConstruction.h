...
class KDMultiTableFeatureConstruction;
...
// Pilotage de la construction de variables pour des donnees multi-tables
class KDMultiTableFeatureConstruction : public KDFeatureConstruction
{
public:
	// Constructeur et destructeur
	KDMultiTableFeatureConstruction();
	~KDMultiTableFeatureConstruction();
...
protected:
	...
	// . KDMultiTableFeatureConstruction::FilterConstructedRules
	...
	// On passe par un pointeur pour eviter les cycle d'inclusion des headers
...
inline void KDMultiTableFeatureConstruction::DataPathPushTableAttribute(const KWAttribute* tableAttribute) const
{
...
inline void KDMultiTableFeatureConstruction::DataPathPopTableAttribute() const
{
	oaDataPathTableAttributes.SetSize(oaDataPathTableAttributes.GetSize() - 1);
}

inline const KWAttribute* KDMultiTableFeatureConstruction::DataPathGetHeadTableAttribute() const
{
...
inline int KDMultiTableFeatureConstruction::DataPathGetLength() const
{
	return oaDataPathTableAttributes.GetSize();
}

inline void KDMultiTableFeatureConstruction::DataPathInit() const
{
