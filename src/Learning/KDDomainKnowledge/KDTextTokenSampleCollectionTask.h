...
protected:
	...
	// Tableau des tokens specifiques dont il faut calculer l'effectif, pour la deuxieme passe
	...
	// Tableau des tokenisers de travail, un par champ de type texte a analyser
