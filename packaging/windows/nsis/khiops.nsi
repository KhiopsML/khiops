...
Section "Install" SecInstall
  ...
  ### Blind attempt to use the launcher???: clean after test
  ...
  ### Blind attempt to use the launcher???: clean after test
  WriteRegStr HKCR "Khiops.File\shell\compile\command" "" '"$INSTDIR\bin\_khiopslauncher.exe" "$INSTDIR\bin\khiops_coclustering.cmd" -i "%1"'
