...
:warning: The scripts in the current repository enable the creation of test or POC packages of Khiops and KNI. Production-ready packages are built on conda-forge.
