...
public:
	...
	// Sortie:
	// 	. oaCollectedTokenSamples: tableau de samples de tokens (ObjectArray de KWTokenFrequency), dans le meme
	// ordre que les variables de type texte
	// Methode interruptible, retourne false si erreur ou interruption (avec
	// message), true sinon
	// Memoire: le tableau en sortie appartient a l'appelant, et doit etre initialement vide.
