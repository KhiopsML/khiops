 ...
 * booleens dans une zone de liste. Utilisation d'une JComboBox.
 *
 * @author Marc Boulle
 */
public class GUIBooleanElementComboBox extends GUIBooleanElement
{

        /**
         * Renvoie le composant d'affichage (JComboBox) contenant les booleens
         *
        ...
        protected JComponent buildComponent()
        {
                ...
                JComboBox jcb = new JComboBox<String>(items);
