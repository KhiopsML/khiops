...
//////////////////////////////////////////////////////////////////////////////////
// Classe KWGrouperMODLBasic

double KWGrouperMODLBasic::dEpsilon = 1e-6;

KWGrouperMODLBasic::KWGrouperMODLBasic() {}

KWGrouperMODLBasic::~KWGrouperMODLBasic() {}

const ALString KWGrouperMODLBasic::GetName() const
{
	return "MODLBasic";
}

KWGrouper* KWGrouperMODLBasic::Create() const
{
	return new KWGrouperMODLBasic;
}
...
boolean KWGrouperMODLBasic::Check() const
{
	boolean bOk;
	bOk = dParam == 0;
	if (not bOk)
...
double KWGrouperMODLBasic::ComputeGarbageCost(int nGarbageMinSize) const
{
...
double KWGrouperMODLBasic::ComputeModelCost(int nGroupNumber, int nValueNumber) const
{
...
double KWGrouperMODLBasic::ComputeGroupCost(IntVector* ivFrequencyVector) const
{
	double dCost;
	int nFrequency;
	int nGroupFrequency;
