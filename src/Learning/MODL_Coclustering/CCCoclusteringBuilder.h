...
protected:
	...
	// Renvoie 1 si l'index de l'attribut d'effectif est invalide
	...
	// Index du premier attribut de type VarPart
	// CH IV Refactoring: cf clarification du cas d'un attribut (le seul) de type VarPart
