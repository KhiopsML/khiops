...
////////////////////////////////////////////////////////////
// Classe KWEvaluatedPredictorSpecArrayView
//    Evaluated predictor
// Editeur de tableau de KWEvaluatedPredictorSpec
class KWEvaluatedPredictorSpecArrayView : public UIObjectArrayView
{
public:
	// Constructeur
	KWEvaluatedPredictorSpecArrayView();
	~KWEvaluatedPredictorSpecArrayView();
