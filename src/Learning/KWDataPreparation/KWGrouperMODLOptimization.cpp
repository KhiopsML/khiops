...
void KWGrouperMODL::MergePureSourceValues(KWFrequencyTable* kwftSource, KWFrequencyTable*& kwftPreprocessedSource,
...
ObjectArray* KWGrouperMODL::BuildReliableSubGroups(KWFrequencyTable* kwftSource, IntVector*& ivGroups) const
{
...
const ALString& KWGrouperMODL::BuildKeyFromIndexes(IntVector* ivIndexMaxValues, IntVector* ivIndexValues) const
{
	const int nBase = 16;
...
ObjectArray* KWGrouperMODL::BuildGroups(KWFrequencyTable* kwftTable) const
{
	ObjectArray* oaGroups;
	KWMODLGroup* group;
	int nSource;
...
KWFrequencyTable* KWGrouperMODL::BuildTable(ObjectArray* oaGroups) const
{
...
ObjectArray* KWGrouperMODL::BuildGroupMerges(ObjectArray* oaGroups) const
{
...
void KWGrouperMODL::MergeSmallGroups(ObjectArray* oaInitialGroups, int nMinFrequency, boolean bOneSingleGarbageGroup,
				     IntVector*& ivGroups) const
{
	const boolean bTrace = false;
...
int KWGrouperMODL::ComputeMinGroupFrequency(ObjectArray* oaInitialGroups, int nTotalFrequency,
...
void KWGrouperMODL::ComputeIndexesFromSourceToEndProcesses(IntVector*& ivSourceToPreprocessedIndexes,
...
void KWGrouperMODL::PostOptimizeGrouping(KWFrequencyTable* kwftSource, KWFrequencyTable* kwftTarget,
					 IntVector* ivGroups) const
{
	const boolean bTrace = false;
...
void KWGrouperMODL::ExhaustiveMergeGrouping(int nMinGroupNumber, KWFrequencyTable* kwftSource,
...
void KWGrouperMODL::PostOptimizeGroups(KWFrequencyTable* kwftSource, KWFrequencyTable* kwftTarget,
				       IntVector* ivGroups) const
{
...
void KWGrouperMODL::FastPostOptimizeGroups(KWFrequencyTable* kwftSource, KWFrequencyTable* kwftTarget,
...
void KWGrouperMODL::FastPostOptimizeGroupsWithGarbage(KWFrequencyTable* kwftSource, KWFrequencyTable* kwftTarget,
						      ...
						      SortedList* frequencyList) const
{
	...
	const boolean bTraceOptimizations = false;
	const boolean bTraceFinalTable = false;
	const boolean bSearchBestOptim = false;
...
void KWGrouperMODL::BuildSingletonGrouping(KWFrequencyTable* kwftSource, KWFrequencyTable*& kwftTarget) const
{
	int nSource;
...
void KWGrouperMODL::PostOptimizeGroupsWithGarbageSearch(ObjectArray* oaInitialGroups, ObjectArray* oaNewGroups,
...
void KWGrouperMODL::PostOptimizeGroupingWithGarbageSearch(ObjectArray* oaInitialGroups, ObjectArray*& oaNewGroups,
...
void KWGrouperMODL::ExhaustiveMergeGroupingWithGarbageSearch(int nMinGroupNumber, ObjectArray* oaInitialGroups,
...
void KWGrouperMODL::ForceBestGroupMergeWithGarbageSearch(ObjectArray* oaSource, ObjectArray* oaTarget,
