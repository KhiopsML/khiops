...
KWPreprocessingSpecView::KWPreprocessingSpecView()
{
	...
	GetFieldAt("MaxPartNumber")
	    ->SetHelpText(
		"Max number of parts generated by preprocessing methods."
		"\n"
		"\n When this interpretability constraint is enabled, it takes precedence over the preprocessing "
		"method's selection criterion."
		"\n The default value is 0, which allows the method to determine the optimal number automatically:"
		"\n - for MODL supervised or unsupervised methods, it sets the optimal number of intervals or value "
		"groups,"
		"\n - for the EqualWidth or EqualFrequency unsupervised discretization methods, it defaults to 10 "
		"intervals,"
