...
class MHDiscretizerHistogramMODL_fp : public KWDiscretizerMODL
{
public:
	// Constructeur
	MHDiscretizerHistogramMODL_fp();
	~MHDiscretizerHistogramMODL_fp();
...
protected:
	...
	// Simplification d'un histogramme optimise selon le nombre max d'intervalles utilisateur
	void SimplifyHistogram(const MHHistogram* optimizedHistogram, MHHistogram*& simplifiedHistogram) const;
	...
	void ExploitHistogram(const MHHistogram* histogram, const ALString& sSuffix) const;
