...
# Configure project
cmake -B conda-build -S . -D BUILD_JARS=OFF -D TESTING=OFF -D CMAKE_BUILD_TYPE=Release -G Ninja

# Build MODL and MODL_Coclustering
cmake --build conda-build --parallel \
...
mv ./conda-build/bin/KNITransfer* "$PREFIX/bin"
