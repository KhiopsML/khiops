...
public:
	...
	// Ce pointeur est positionne en retour vers un buffer gere par InputBufferedFile, ce buffer pouvant
	...
	// Dans ce cas uniquement, on peut avoir potentiellement une erreur de type LineTooLong
