...
class MHTruncationDiscretizerHistogramMODL_fp : public MHDiscretizerHistogramMODL_fp
{
public:
	// Constructeur
	MHTruncationDiscretizerHistogramMODL_fp();
	~MHTruncationDiscretizerHistogramMODL_fp();
...
protected:
	...
	// pour leur taille initiale. Dans ce cas, on fiusionne les intervalles posant probleme avec leur predecesseur
