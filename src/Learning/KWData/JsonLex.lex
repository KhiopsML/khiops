...
% option yylineno
	    ...
	    DIGIT[0 - 9] DIGIT1[1 - 9] INTNUM{DIGIT1} {DIGIT} *
	FRACT "." {DIGIT} +
...
?
    ...
    UNICODE         \\u[A - Fa - f0 - 9]{4} ESCAPECHAR      \\["\\/bfnrt]
...
true
{
	bJsonTokenBoolean = true;
	return JSONTokenizer::Boolean;
}
false
{
...
{WHITESPACE} {/*IGNORE*/}
    ...
    .
{
	sJsonTokenString = yytext;
	return JSONTokenizer::Error;
}
