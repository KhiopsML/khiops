							     ...
							     const ALString& sAttributeName) const
{
	...
	// Export de la granularite pour la table de contingence
...
{
	//DDD KWDataGridManager referenceDataGridManager;
	...
	//DDD referenceDataGridManager.SetSourceDataGrid(referenceDataGrid);
