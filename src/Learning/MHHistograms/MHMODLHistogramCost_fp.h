...
class MHMODLHistogramCosts_fp : public KWUnivariatePartitionCosts
{
public:
	// Constructeur
	MHMODLHistogramCosts_fp();
	~MHMODLHistogramCosts_fp();
	...
	// DEPRECATED
	// Methode avancee pour forcer un comportement oriente histogramme a representation virgule fixe,
	// base sur des bins de taille fixe et non de taille flotante.
	// Methode temporaire "bidulique", uniquement le temps de la these de Valentina
	// Impacts:
	//  . choix des bornes extremes de l'histogramme base sur un epsilon fixe
	//  . dans les couts, on ignore les couts de choix des hyper-parametres et du choix de l'exposant du central bin
	static boolean EnforceFixedSizeBinsBehavior();
