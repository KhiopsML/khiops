...
/////////////////////////////////////////////////////////////////////////
// Classe DTGrouperMODLTwoClasses

DTGrouperMODLTwoClasses::DTGrouperMODLTwoClasses()
{
	SetDiscretizationCosts(new DTMODLGroupingCosts);
...
void DTGrouperMODLTwoClasses::Group(KWFrequencyTable* kwftSource, int nInitialSourceValueNumber,
...
void DTGrouperMODLTwoClasses::GroupSortedTable(KWFrequencyTable* kwftSortedSource, int nInitialSourceValueNumber,
					       KWFrequencyTable*& kwftTarget, IntVector*& ivGroups) const
{
	int nSource;
	int nGroupSize;
...
void DTGrouperMODLTwoClasses::PostOptimizeGrouping(KWFrequencyTable* kwftSortedSource, int nInitialSourceValueNumber,
...
const ALString DTGrouperMODLTwoClasses::GetName() const
{
	return "MODLTwoClasses";
}

void DTGrouperMODLTwoClasses::InitializeWorkingData(const KWFrequencyTable* kwftSource) const {}

void DTGrouperMODLTwoClasses::CleanWorkingData() const {}

void DTGrouperMODLTwoClasses::DiscretizeFrequencyTable(KWFrequencyTable* kwftSource,
...
boolean DTGrouperMODLTwoClasses::GetModalityNumberMonitoring() const
{
	return bSearchGarbage;
}
void DTGrouperMODLTwoClasses::SetModalityNumberMonitoring(boolean bValue) const
{
	bSearchGarbage = bValue;
}

SortedList* DTGrouperMODLTwoClasses::GetWorkingFrequencyList() const
{
	return workingFrequencyList;
}

void DTGrouperMODLTwoClasses::SetWorkingFrequencyList(SortedList* frequencyList) const
{
...
void DTGrouperMODLTwoClasses::ResetWorkingFrequencyList() const
{
	require(workingFrequencyList != NULL);
	workingFrequencyList = NULL;
...
void DTGrouperMODLTwoClasses::AddIntervalToWorkingFrequencyList(KWMODLLine* interval) const
{
...
void DTGrouperMODLTwoClasses::RemoveIntervalFromWorkingFrequencyList(KWMODLLine* interval) const
{
	if (GetModalityNumberMonitoring())
	{
		require(interval != NULL);
...
void DTGrouperMODLTwoClasses::InitializeFrequencySortedList(SortedList* frequencyList, KWMODLLine* headInterval) const
{
	const boolean bTrace = false;
	KWMODLLine* interval;
...
int DTGrouperMODLTwoClasses::ComputeModalityNumber(const KWFrequencyTable* kwftSource, int nFirstIndex,
...
int DTGrouperMODLTwoClasses::ComputeGarbageModalityNumberFromTable(KWFrequencyTable* kwftTargetWithGarbage) const
{
	int nGroupIndex;
	int nModalityNumber;
	int nGarbageModalityNumber;
...
int DTGrouperMODLTwoClasses::GetIntervalListTotalModalityNumber(const KWMODLLine* headLine) const
{
	const boolean bTrace = false;
	int nModalityNumber;
...
KWMODLLine* DTGrouperMODLTwoClasses::IntervalListOptimizationWithGarbage(
...
void DTGrouperMODLTwoClasses::IntervalListBestMergeOptimizationWithGarbage(
...
void DTGrouperMODLTwoClasses::IntervalListPostOptimizationWithGarbage(const KWFrequencyTable* kwftSource,
								      KWMODLLineDeepOptimization*& headInterval,
								      int nGarbageModalityNumber) const
{
	const boolean bTraceOptimisationDetails = false;
...
void DTGrouperMODLTwoClasses::SortFrequencyTableByTargetRatio(KWFrequencyTable* kwftFrequencyTable, boolean bAscending,
...
void DTGrouperMODLTwoClasses::IntervalListMergeOptimizationWithGarbagePartitionCost(
...
boolean DTGrouperMODLTwoClasses::IsFrequencyTableSortedByTargetRatio(KWFrequencyTable* kwftFrequencyTable,
