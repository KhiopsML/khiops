...
////////////////////////////////////////////////////////////
// Classe KIPredictorAttributeArrayView
//    Predictor variable
// Editeur de tableau de KIPredictorAttribute
class KIPredictorAttributeArrayView : public UIObjectArrayView
{
public:
	// Constructeur
	KIPredictorAttributeArrayView();
	~KIPredictorAttributeArrayView();
