...
REM Copy the khiops-core binaries to the Conda PREFIX path: MODL, MODL_Cocluetsring and _getprocnumber.
...
copy build\windows-msvc-release\bin\_getprocnumber.exe %PREFIX%\bin
